---
title: Simple Audio Recognition on a Raspberry Pi using Machine Learning (I2S, TensorFlow
  Lite)
description: "...Adapt the official TensorFlow simple audio recognition example to
  use live audio data from an I2S microphone on a Raspberry Pi."
featured_image: "/images/2021/01/IMG_5446-1024x683.jpg"
tags:
- TensoFlow
- ML
- Raspberry Pi
